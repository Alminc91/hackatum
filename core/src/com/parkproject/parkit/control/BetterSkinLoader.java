package com.parkproject.parkit.control;
...
public class BetterSkinLoader extends SkinLoader {
    ...
    private Map<String,BitmapFont> initFonts() {
        FileHandle fontFile = Gdx.files.internal("marketing_script.ttf");
        ...
        param.size = Math.round( width *0.85f);
        fontsByName.put( "bighuge-font", generator.generateFont( param ));
